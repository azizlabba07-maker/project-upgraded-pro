  ...
  return (
    <AbsoluteFill style={{ backgroundColor: tokens.colors.background }}>
      ...
      <div style={{ position: 'absolute', top: '50%', left: '50%', transform: `translate(-50%, -50%) scale(${titleScale})`, opacity: contentOpacity, textAlign: 'center' }}>
        <h1 style={{ fontSize: '120px', fontFamily: 'system-ui, sans-serif', fontWeight: 700, color: tokens.colors.foreground, textShadow: `0 0 40px ${tokens.colors.primary}`, letterSpacing: '-2px' }}>
          Abstract Motion
        </h1>
        <p style={{ fontSize: '32px', color: tokens.colors.primary, marginTop: '20px', opacity: 0.8 }}>
          Generated by AI Motion Engine
        </p>
      </div>
    </AbsoluteFill>
  );
